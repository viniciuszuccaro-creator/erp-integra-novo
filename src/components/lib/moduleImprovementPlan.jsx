...
export const MODULE_IMPROVEMENT_STATUS = {
  ...
  Fiscal:            { progress: 100, focus: "Validação fiscal IA, NF-e, ValidacaoCertificadoNFe + IAContextualModulo no header" },
  RH:                { progress: 100, focus: "Colaboradores, ponto biométrico, IA de insights + SemEmpresaBanner + header integrado" },
  Expedição:         { progress: 100, focus: "Entregas, IA de rotas, roteirização, SemEmpresaBanner + IA header" },
  Relatórios:        { progress: 100, focus: "Análises multiempresa, IA executiva, SemEmpresaBanner + IAContextualModulo integrado" },
  ...
  Contratos:         { progress: 100, focus: "KPIs, IA de risco, renovação, cobrança automática + IAContextualModulo integrado" },
  ...
  Produção:          { progress: 100, focus: "OPs, apontamentos, IA diagnóstico, SemEmpresaBanner + IAContextualModulo integrado" },
