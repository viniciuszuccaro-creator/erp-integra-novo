...
import { melhoriaPlanPhases, ciclo24Items } from '@/components/sistema/plano-melhoria/melhoriaPlanData';
...
export default function PlanoMelhoria() {
  ...
  // Ciclo atual = Ciclo 24 (Julho 2026)
  const cicloAtualItems = ciclo24Items;
    ...
    <div className="flex h-full w-full flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-2xl bg-gradient-to-r from-blue-900 via-indigo-900 to-violet-900 p-5 text-white">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-blue-200 text-sm">ERP Zuccaro V24 — Melhoria contínua · Ciclo 24 · Julho 2026</p>
        </div>
