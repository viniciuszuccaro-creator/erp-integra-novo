  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-end gap-2 no-print">
        <Button data-permission="Producao.DocumentosProducao.exportar" onClick={handleImprimir} className="bg-blue-600">
          <Printer className="w-4 h-4 mr-2" />
          Imprimir
        </Button>
        <Button data-permission="Producao.DocumentosProducao.exportar" onClick={handleDownloadPDF} variant="outline">
