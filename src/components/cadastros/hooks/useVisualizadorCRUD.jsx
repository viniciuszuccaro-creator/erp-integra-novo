...
function getDescricaoField(formData, ENTITY) {
  const DESC_FIELDS_BY_ENTITY = {
    ...
    GrupoProduto: ['nome', 'nome_grupo', 'descricao'],
    KitProduto: ['nome_kit', 'nome', 'descricao'],
    SetorAtividade: ['nome_setor', 'nome', 'descricao'],
    PerfilAcesso: ['nome_perfil', 'nome', 'descricao'],
    Cargo: ['nome_cargo', 'nome', 'descricao'],
    Departamento: ['nome_departamento', 'nome', 'descricao'],
    Turno: ['nome_turno', 'nome', 'descricao'],
    CondicaoComercial: ['nome_condicao', 'nome', 'descricao'],
    Empresa: ['razao_social', 'nome_fantasia'],
    GrupoEmpresarial: ['nome', 'descricao'],
    TipoFrete: ['nome', 'descricao', 'codigo'],
    LocalEstoque: ['nome', 'tipo'],
    ...
    CentroResultado: ['nome', 'descricao', 'codigo'],
