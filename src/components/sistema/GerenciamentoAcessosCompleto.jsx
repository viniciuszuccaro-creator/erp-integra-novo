...
import PerfilFormDialog from "./gerenciamento-acessos/PerfilFormDialog";
          ...
          <Card>
            <CardHeader className="bg-slate-50 border-b flex flex-row items-center justify-between">
              ...
              <PerfilFormDialog
                ...
                setEditingPerfil={setEditingPerfil}
                formPerfil={formPerfil}
                setFormPerfil={setFormPerfil}
                onSubmit={handleSubmitPerfil}
                aplicarTemplateNivel={aplicarTemplateNivel}
                conflitosSOD={conflitosSOD}
                selecionarTudoGlobal={selecionarTudoGlobal}
                moduloExpandido={moduloExpandido}
                setModuloExpandido={setModuloExpandido}
                contarPermissoesModulo={contarPermissoesModulo}
                temPermissao={temPermissao}
                togglePermissao={togglePermissao}
                marcarTodoModulo={marcarTodoModulo}
                marcarTodoSecao={marcarTodoSecao}
                salvarPerfilMutation={salvarPerfilMutation}
                resetFormPerfil={resetFormPerfil}
              />
            </CardHeader>
