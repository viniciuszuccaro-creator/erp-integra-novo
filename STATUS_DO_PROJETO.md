...
4. Investigar `marketplaceSync` (2h, 4 falhas consecutivas ativas) e `Propagacao Noturna Grupo→Empresas` (1 falha) apos os creditos voltarem — se persistirem, depurar funcao/credenciais.
