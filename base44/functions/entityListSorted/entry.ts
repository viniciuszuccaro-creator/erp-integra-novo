...
const SEARCH_FIELDS = {
  ...
  Departamento: ['nome_departamento', 'nome', 'descricao', 'codigo'],
  Turno: ['nome_turno', 'nome', 'descricao', 'codigo'],
  ...
  CondicaoComercial: ['nome_condicao', 'nome', 'descricao', 'codigo'],
  TabelaFiscal: ['descricao', 'nome', 'uf'],
  LocalEstoque: ['descricao', 'codigo', 'nome'],
  RotaPadrao: ['nome', 'nome_rota', 'regiao'],
  ModeloDocumento: ['nome_modelo', 'tipo', 'descricao', 'nome'],
