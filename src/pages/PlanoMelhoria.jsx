...
import { melhoriaPlanPhases, ciclo11Items, ciclo12Items, ciclo13Items, ciclo14Items, ciclo15Items, ciclo16Items, ciclo17Items, ciclo18Items, ciclo19Items } from '@/components/sistema/plano-melhoria/melhoriaPlanData';
...
export default function PlanoMelhoria() {
  ...
  // Ciclo atual = Ciclo 19
  const cicloAtualItems = ciclo19Items;
    ...
    <div className="flex h-full w-full flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-2xl bg-gradient-to-r from-blue-900 via-indigo-900 to-violet-900 p-5 text-white">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-blue-200 text-sm">ERP Zuccaro V21.5 — Melhoria contínua · Ciclo 19 · Janeiro 2027</p>
        </div>
