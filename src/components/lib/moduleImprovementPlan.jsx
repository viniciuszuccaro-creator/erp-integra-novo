...
export const MODULE_IMPROVEMENT_STATUS = {
  ...
  Fiscal:            { progress: 99, focus: "Validação fiscal IA, NF-e, SPED, certificado guard e compliance tributário" },
  RH:                { progress: 99, focus: "Colaboradores, ponto biométrico, IA de insights + header integrado ciclo 12" },
