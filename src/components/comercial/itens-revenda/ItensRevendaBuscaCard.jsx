    ...
    <Card className="border-2 border-blue-300 bg-blue-50">
      ...
      <CardContent className="space-y-4">
        <div className="flex gap-3">
          ...
          <Button onClick={copiarUltimoPedido} variant="outline" disabled={!formData?.cliente_id}>
        ...
        {produtoSelecionado && (
          <div className="bg-white border-2 border-blue-600 rounded-lg p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <Button onClick={sugerirQuantidadeIA} size="sm" variant="outline" className="border-purple-300 text-purple-600" disabled={!formData?.cliente_id}>
            ...
            <Button onClick={adicionarItem} className="w-full mt-3 bg-blue-600 hover:bg-blue-700">
